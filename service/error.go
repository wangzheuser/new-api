...
func RelayErrorHandler(ctx context.Context, resp *http.Response, showBodyWhenFail bool) (newApiErr *types.NewAPIError) {
	...
	if common.GetJsonType(errResponse.Error) == "object" {
		...
		if oaiError != nil {
			newApiErr = types.WithOpenAIError(*oaiError, resp.StatusCode, upstreamStatusOption)
			if showBodyWhenFail {
	...
	newApiErr = types.NewOpenAIError(errors.New(errResponse.ToMessage()), types.ErrorCodeBadResponseStatusCode, resp.StatusCode, upstreamStatusOption)
	if showBodyWhenFail {
		newApiErr.Err = buildErrWithBody(newApiErr.Error())
	}
	return
