...
// ConvertGeminiRequest reuses the registered Gemini-to-Messages conversion.
...
// ConvertOpenAIResponsesRequest preserves the client format while converting the upstream body.
