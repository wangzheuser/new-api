...
var auditContentTemplates = map[string]string{
	...
	"user.group_grants_update":      "Updated group grants for user ${target_user_id}",
	...
	"user_rate_limit.config_update": "Updated user rate-limit response configuration",
	"user_rate_limit.rule_create":   "Created user rate-limit rule ${rule_id} for ${group}",
	"user_rate_limit.rule_update":   "Updated user rate-limit rule ${rule_id} for ${group}",
	"user_rate_limit.rule_delete":   "Deleted user rate-limit rule ${rule_id} for ${group}",
	...
	"subscription.user_update":     "Updated subscription ${subscription_id} for user ${target_user_id}",
