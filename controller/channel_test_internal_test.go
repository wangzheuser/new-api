...
func TestChannelTestFinalClientResponseMatrix(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "anthropic non-stream", endpointType: constant.EndpointTypeAnthropic, upstreamBody: chatResponse, contentType: "application/json", wantContent: "answer", wantRawSubstring: `"type":"message"`},
